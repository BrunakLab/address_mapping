...
(regions_coord |>
    ggplot() +
    geom_polygon(mapping = aes(x = X, y = Y, group = group_id), fill = "deepskyblue4", color = "white") +
    geom_point(
        data = shak_coords,
    ...
    guides(fill = guide_legend(ncol = 1, theme = theme(legend.text = element_text(size = 4)))))
